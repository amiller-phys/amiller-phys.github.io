...
<aside>
📏 Some abbreviations are acceptable, but writing out all words completely avoids confusion.

</aside>

Titles in names — such as `Mr.`, `Ms.`, or `Jr.` — should be abbreviated. These abbreviations are common enough that writing out `Mister` or `Junior` would be awkward.
