...
Wherever possible, avoid using the inline math environment in a block heading. The math formatting is ugly beside the large, boldface heading text. Since we write about STEM topics, avoidance is going to be an inadequate solution sometimes. If you want to use math formatting in a heading, please flag it in the `#editorial-lounge` slack channel.
